#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fine-tuning strategy helpers for unified TUAB EEG-FM adapter workers."""
...
STRICT_LORA_TARGETS = {"labram_reference", "strict_labram_reference"} | MERIEM_EXACT_LORA_TARGETS
LORA_AUTO_TOKENS = (
    "qkv",
    "query",
    "key",
