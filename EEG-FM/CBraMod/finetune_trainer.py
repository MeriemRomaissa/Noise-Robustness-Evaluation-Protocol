...
def _add_benchmark_finetuning_path_to_syspath():
    """Let CBraMod reuse Benchmark LoRA helpers without changing model code."""
...
def _apply_benchmark_finetune_strategy(model, params):
    ...
    params.model_name = "CBraMod"
    params.allow_head_guess = True
    summary = lora_cbramod.apply_strategy(model, params)
        ...
        if self.params.optimizer == 'AdamW':
            ...
            if benchmark_strategy_active:
                ...
                if not trainable_params:
                    raise RuntimeError("No trainable parameters found for CBraMod optimizer.")
