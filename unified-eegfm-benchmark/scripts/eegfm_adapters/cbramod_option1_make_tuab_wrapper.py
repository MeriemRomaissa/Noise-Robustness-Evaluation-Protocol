#!/usr/bin/env python3
"""CBraMod Option 1 TUAB preprocessing wrapper.

Project-local wrapper for the matched-subset comparison. It faithfully mirrors
CBraMod's TUAB EDF transform while preserving the approved Option 1
train/val/test split and never scanning the full TUAB root.
"""
...
DEFAULT_OUTPUT_ROOT = ROOT / "data" / "cbramod_option1_original_processed"
REPORT_JSON = ROOT / "reports" / "cbramod_option1_preprocessing_wrapper_summary.json"
REPORT_MD = ROOT / "reports" / "cbramod_option1_preprocessing_wrapper_report.md"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="CBraMod Option 1 TUAB preprocessing wrapper.")
...
def write_reports(summary: dict[str, Any]) -> None:
    ...
    lines = [
        "# CBraMod Option 1 Preprocessing Wrapper Report",
        "",
        ...
        "",
        "## Original CBraMod TUAB Transform",
        "",
        "- Resample to 200 Hz.",
