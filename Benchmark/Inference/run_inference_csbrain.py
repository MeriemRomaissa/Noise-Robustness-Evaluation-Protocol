...
def main():
    ...
    output_dir = Path(args.output_dir or paths.get("output", "outputs/csbrain"))
    ...
    dataset = NmtPickleDataset(args.nmt_dir, transform_config, max_samples=args.max_samples)
